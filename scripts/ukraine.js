  ...
  const nuclearFacilitiesData = [
    {
      ...
      description: "Its construction began in 1973. It started with two nuclear reactors in 1980-1981, and added two more by 2004. With 2,835 MW, it powers millions of homes yearly. Despite the Ukraine-Russia war, it operates safely with non-Russian fuel."
    },
    {
    ...
    },
    {
      ...
      lon: 26.65247,
      type: "Nuclear power plant",
      description: "It generates electricity with two reactors running since 1987 and 2004. Two new reactors are being built with US technology. It stays safe despite nearby Russian attacks in 2023."
    },
    {
      address: "Mykolaiv",
      lat: 46.97586,
    ...
    },
    {
      ...
      description: "Secure underground facility for tactical nuclear warheads storage"
    },
    {
      address: "Kyiv",
      lat: 50.41207,
      lon: 30.44389,
      type: "Major military-industrial enterprise",
      description: "The Antonov facility produced large transport aircraft that, while not designed as bombers, had the physical capacity to carry nuclear weapons as cargo during the Soviet era. After Ukraine's denuclearization, these aircraft served exclusively non-nuclear roles."
    },
    {
      address: "Vinnytsia",
      lat: 49.23202,
    ...
    },
    {
      ...
      lon: 29.8142,
      type: "Strategic missile divisions",
      description: "The secret military town of Makariv-1 was established In 1969. It housed two military units (one responsible for nuclear weapons maintenance, the other for military seismology) and a concrete manufacturing plant. In 1996, all nuclear weapons were relocated to Russia."
    },
    {
      address: "Chornobyl",
      lat: 51.27055,
      lon: 30.21956,
      type: "Nuclear power plant",
      description: "Chernobyl Nuclear Power Plant was the site of the 1986 nuclear disaster, the worst ever, fuelling anti-nuclear sentiment that helped push Ukraine to abandon nuclear weapons by 2001. Now shut down, its fourth reactor is encased in a steel shield, damaged by a Russian drone in 2025 with no radiation leak."
    },
    {
      address: "Pervomaisk",
      lat: 47.6816,
      lon: 29.20928,
      type: "Strategic missile divisions",
      description: "In Pervomaisk, the Soviet 46th Missile Division controlled 40 SS-19 Stiletto missiles (up to six warheads each) and 46 SS-24 Scalpel missiles (multiple warheads). Ukraine dismantled them by 2001, and the division is now inactive."
    },
    {
      ...
      lon: 35.34002,
      type: "Nuclear power plant",
      description: "The Zaporizhzhia Nuclear Power Plant is Europe's largest nuclear facility, with six reactors built between 1985-1996. Designed solely for civilian power generation, it previously supplied about 20% of Ukraine's electricity. Since Russia's 2022 invasion, the plant has been occupied, raising serious international safety concerns."
    },
    {
      address: "Sevastopol",
      lat: 44.55517,
    ...
    },
    {
      ...
      lon: 36.23101,
      type: "Major military-industrial enterprise",
      description: "Established in 1959, Khartron was a specialized facility that created guidance computers and control systems for Soviet nuclear missiles. Though it never made nuclear warheads, its technology was crucial for directing missiles to their targets. After independence, it shifted to civilian technology."
    },
    {
      address: "Kharkiv",
      lat: 50.09436,
      lon: 36.26277,
      type: "Nuclear research institute",
      description: "The Institute of Physics and Technology was a major Soviet nuclear research centre established in 1928. It housed experimental reactors and accelerators that once supported weapons research. After Ukraine's independence, it converted to peaceful nuclear science under international monitoring."
    },
    {
      address: "Pryluky",
      lat: 50.61212,
    ...
    },
    {
      ...
      lon: 31.22062,
      type: "Nuclear power plant",
      description: "The South Ukraine Nuclear Power Plant operates three 1,000 MW reactors that came online between 1982-1989. Built solely for civilian power generation, it provides about 10% of Ukraine's electricity. The facility has always been separate from any military nuclear program and operates under international safety monitoring."
    },
    {
      address: "Uzyn",
      lat: 49.82847,
      lon: 30.41972,
      type: "Strategic aviation",
      description: "Former base for the 106th Bomber Regiment which once operated 25 Tu-95MS strategic bombers, capable of carrying nuclear missiles. Ukraine transferred these to Russia by 2000, and the regiment was disbanded by 2006. "
    },
    {
      address: "Tsybuleve",
      lat: 48.81752,
      lon: 32.47767,
      type: "Nuclear warhead storage",
      description: "This Soviet military nuclear waste site threatened local health until recently. In partnership with NATO, Ukraine removed radioactive materials from three concrete storage wells and transported them to the disposal facility in the Chernobyl Zone."
    },
    {
      address: "Feodosiya",
      lat: 45.03312,
